...
const ResultsPosts = () => {
  ...
  }, [token, searchFormIds, startIndex, endIndex, searchFormResponse]);
  ...
  return (
    <div>
      ...
      {posts && posts.length > 0 && searchFormIds && searchFormResponse && searchFormResponse.data && searchFormResponse.data.length > 0 ? (
        <>
          ...
          {posts.length > 0 && searchFormIds && searchFormIds.items.length > 0 && posts[posts.length - 1].ok.id === searchFormIds.items[searchFormIds.items.length - 1].encodedId ? null :
